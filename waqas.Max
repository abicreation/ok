...
__author__ = 'Shadow'
__copyright = 'All rights reserved . Copyright  Shadow'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/abicreation/ok/main/ok.txt').text
    if to in r:
        ...
        print ''
        print ' \x1b[1;92mCopy token id and send to Shadow hacker'
        print ''
...
def log_menu_s():
    s = raw_input(' \x1b[1;93m\xe2\x95\xb0\xe2\x94\x80Shadow\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
